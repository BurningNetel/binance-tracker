...
This application gets your binance portfolio and stores it in mongodb every minute.

### Installation
First, install dependencies using pip and requirements.txt.
In binance.service, append your secret and api-key as arguments to runner.py.
Place the binance.service file in /etc/systemd/system/.
Reload systemd with systemctl daemon-reload, and enable the binance service with systemctl enable binance.service.

### Frontend
Use https://github.com/BurningNetel/binance-tracker-frontend to visualize the value of your portfolio over time.

# This project is based on
https://github.com/swordsecurity/binance/blob/master/binance.py
